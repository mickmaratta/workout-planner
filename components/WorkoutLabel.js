...
const WorkoutLabel = ({ workout, all, drag }) => {
  ...
  return (
    <TouchableOpacity onLongPress={drag} onPress={() => navigation.navigate('View_Workout', {workout})} className=" flex-row items-center justify-between mx-3 py-2 border-solid border-b-2 border-gray-200">
      <View>
